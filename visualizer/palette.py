...
DA_LIGHTBLUE10 = list(map(hex_to_rgb, [
    '#c0e4ff',
    '#97d3ff',
    '#57b8ff',
    '#008bf2',
...
DA_GREEN10 = list(map(hex_to_rgb, [
    '#c2e5d1',
    '#9bd4b5',
    '#71c598',
    '#2cac6e',
...
DA_YELLOW10 = list(map(hex_to_rgb, [
    '#fbf5e0',
    '#ffd43d',
    '#ebb700',
    '#d2a400',
...
DA_ORANGE10 = list(map(hex_to_rgb, [
    '#ffeee2',
    '#ffc199',
    '#ffa66d',
    '#ff7628',
...
DA_MAGENTA10 = list(map(hex_to_rgb, [
    '#ffaeff',
    '#ff8eff',
    '#f661f6',
    '#f137f1',
...
DA_PURPLE10 = list(map(hex_to_rgb, [
    '#ddc2ff',
    '#cda6ff',
    '#bb87ff',
    '#a565f8',
